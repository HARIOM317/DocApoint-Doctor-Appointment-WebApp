...
def predict_disease():
    ...
    # Call SVM function for prediction
    psymptoms = data['symptoms']

    # Predict disease
    predicted_disease = SVM(psymptoms)
...
def SVM(psymptoms):
    #symptoms
    a = np.array(['itching', 'skin_rash', 'nodal_skin_eruptions',
    ...
    #weights
    b = np.array([1, 3, 4, 4, 5, 3, 3, 5, 3, 4, 3, 5, 6, 6, 4, 3, 4, 5, 3, 3, 5, 2,
