...
const Blog = () => {
  ...
  if (!isLoading && !isError && blogData?.length > 0)
    content = (
      <>
        {blogData?.map((item) => (
          <div
            className="col-md-4 col-sm-12 mb-3 custom-blog-card"
            key={item?.id}
          >
  ...
  return (
    <div
      className="container"
      style={{ marginTop: "8.5rem", marginBottom: "7rem" }}
    >
      ...
      <div className="container">
        <div
          className="row py-5 align-items-center justify-content-center rounded"
