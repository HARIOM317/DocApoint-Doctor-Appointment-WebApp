        ...
        <ChatBot
          ...
          steps={[
            ...
            },
            {
              id: "OAB",
              message:
                "Users can conveniently book appointments with their preferred doctors through our platform. With just a few clicks, they can schedule their visit without the hassle of waiting in long queues or making multiple phone calls.",
              trigger: "service-provide",
            },
            {
              id: "DR",
              message:
                "Patients can choose their doctors based on detailed profiles and reviews from other users. This feature helps them make informed decisions about their healthcare providers, ensuring they receive quality care that meets their needs.",
              trigger: "service-provide",
            },
            {
              id: "DS",
              message:
                "Doctors can manage their availability for the upcoming week, making it easier for patients to find a suitable time for their appointments. This scheduling feature enhances efficiency and reduces wait times for both doctors and patients.",
              trigger: "service-provide",
            },
            ...
            },
            {
              id: "doctor",
              message:
                "Thanks ! let's meet speciality for which you like to Specialization Doctors .",
              trigger: "exportD",
            },
              ...
              options: [
                {
                  ...
                  trigger: () =>
                    handleLinkClick("http://localhost:3001/doctors"),
                },
...

            {
              id: "Q5",
              message:
                "Hello, welcome to DocApoint symptom triage, with world-class content from the hospital and Clinic.",
              trigger: "sym",
            },
            {
              id: "sym",
              message:
                "This symptom checker should not be used for any medical emergencies. Of the following emergency symptoms, please choose any that apply to your situation.",
              trigger: "symCh",
            },
            {
              id: "symCh",
              options: [
                {
                  value: 1,
                  label: "Crushing chest pain, difficulty breathing",
                  trigger: "emrgency",
                },
                {
                  value: 2,
                  label:
                    "Sudden face drooping, difficulty speaking, weakness or numbness",
                  trigger: "emrgency",
                },
                {
                  value: 3,
                  label: "Heavy bleeding after an injury or accident",
                  trigger: "emrgency",
                },
                {
                  value: 4,
                  label: "Poisoning, swallowing something you shouldn't have",
                  trigger: "emrgency",
                },
                {
                  value: 5,
                  label: "Seizure, inability to stay alert and awake",
                  trigger: "emrgency",
                },
                {
                  value: 6,
                  label: "Sudden facial, mouth, or throat swelling",
                  trigger: "emrgency",
                },
            ...
            },
            {
              id: "emrgency",
              message:
                " Your response indicates you need medical attention now. Please call your local emergency number immediately.",
              trigger: "q-submit",
            },
            {
              id: "generalSymt",
            ...
            },
            {
              ...
              options: [
                {
                  value: 1,
                  label: "Not sure or lower than 100.4F (38C)",
                  trigger: "loc100",
                },
                {
                  value: 2,
                  label: "Between 100.4F and 103F (38C and 39.4C)",
                  trigger: "loc100",
                },
                {
                  value: 3,
                  label: "Between 103F and 104.8F (39.4C and 40.4C)",
                  trigger: "loc100",
                },
                {
                  value: 4,
                  label: "104.9F or higher (>40.5C)",
                  trigger: "loc100",
                },
              ],
            },
            ...
            },
            {
              id: "ybacs",
              message:
                "Recommend over-the-counter medications like acetaminophen or ibuprofen, rest, and hydration for fever treatment.",
            ...
            },
            {
              id: "ycwh",
              message:
                "Cough treatment may include over-the-counter cough suppressants, hydration, and addressing underlying causes.",
              trigger: "symptom-question-submit",
            },
            ...
            },
            {
              ...
              options: [
                {
                  value: "1",
                  label: "Like one I have had before",
                  trigger: "headacheT",
                },
                {
                  value: "2",
                  label: "A new type of headache",
                  trigger: "headacheT",
                },
            ...
            },
            {
              ...
              options: [
                {
                  value: "1",
                  label: "Discomfort or mild pain",
                  trigger: "headacheSvr",
                },
                {
                  value: "2",
                  label:
                    "Moderate: limiting activities and/or need for painkillers",
                  trigger: "headacheSvr",
                },
                {
                  value: "3",
                  label:
                    "Severe: close to the worst pain I have ever experienced",
                  trigger: "headacheSvr",
                },
              ],
            },
            ...
            },
            {
              id: "headacheSvr",
              message:
                "How long has your current headache been going on?(Days)",
            ...
            },
            {
              id: "yhdchns",
              message:
                "headaches, recommend over-the-counter pain relievers, rest, hydration, and stress management.",
              trigger: "symptom-question-submit",
            },
            ...
            },
            {
              ...
              options: [
                ...
                {
                  value: "2",
                  label: "Three to five times",
                  trigger: "vomitingHrs",
                },
                {
                  value: "3",
                  label: "More than six times",
                  trigger: "vomitingHrs",
                },
              ],
            },
            ...
            },
            {
              id: "yvmtdhdr",
              message:
                "Treatment for vomiting includes hydration, antiemetics, and addressing underlying causes such as infections or gastrointestinal disorders.",
              trigger: "symptom-question-submit",
            },
            ...
            },
            {
              id: "yabdmgas",
              message:
                "Treatment of abdominal pain with pain relievers, rest, hydration, and addressing underlying causes.",
              trigger: "symptom-question-submit",
            },
...

            {
              id: "Q6",
              message:
                "Please choose one of the following to know their contact details.",
              trigger: "cntct",
            },
            {
              id: "cntct",
