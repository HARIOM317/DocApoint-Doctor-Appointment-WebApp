    ...
    content = (
      <>
        ...
        >
          ...
          <div>
            <h4 className="text-center my-3 fw-bold">APPOINTMENT INFOMATION</h4>
          ...
          <div>
            <h4 className="text-center my-3 fw-bold text-secondary">
              DOCTOR INFOMATION
            </h4>
            {data?.doctor && (
            ...
            <div className="border border-light-subtle rounded p-3 d-flex gap-3">
              ...
              <div>
                ...
                <div className="mt-2">
                  <p className="mb-1 form-text">
                    Reason for Visit :{" "}
                    <span className="text-warning">{data?.reasonForVisit}</span>
                  </p>
                  <p className="mb-1 form-text">
                    Description :{" "}
